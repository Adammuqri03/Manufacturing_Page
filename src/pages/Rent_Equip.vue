...
export default {
  setup() {
    ...
    const images = [
      {
        src: "/img/eqp/rental_1.png",
        title: "Chauvin Arnoux, PEL 103",
      },
      { src: "/img/eqp/rental_2.png", title: " Chauvin Arnoux, MN93" },
      { src: "/img/eqp/rental_3.png", title: " Testo 540" },
    ...
    // Methods for opening social media links
    const openFacebook = () => {
